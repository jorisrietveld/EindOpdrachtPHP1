...
class EasyGoogleMap
{
     ...
     * @access: private
     */
    private $mInfoWindowTextArr = array();
     ...
     * @return: void
     */
    public function SetInfoWindowText($info)
    {
     ...
     * @return: void
     */
    public function SetSideClick($str)
    {
